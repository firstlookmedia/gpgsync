...
def test_get_fingerprint_list_valid(keylist):
    # None of these should throw exceptions
    keylist.get_fingerprint_list(get_keylist_file_content('fingerprints.txt'))
    keylist.get_fingerprint_list(get_keylist_file_content('fingerprints_comments.txt'))
    keylist.get_fingerprint_list(get_keylist_file_content('fingerprints_no_whitespace.txt'))
    keylist.get_fingerprint_list(get_keylist_file_content('fingerprints_weird_whitespace.txt'))


def test_get_fingerprint_list_invalid_fingerprints(keylist):
    with pytest.raises(InvalidFingerprints):
        keylist.get_fingerprint_list(get_keylist_file_content('invalid_fingerprints.txt'))
